...
from flight_deal_finder_notification_manager import NotificationManager
from flight_deal_finder_flight_search import FlightSearch
from flight_deal_finder_flight_data import FlightData
from flight_deal_finder_data_manager import DataManager
from flight_deal_finder_user_manager import UserManager

from datetime import datetime, timedelta
from dateutil.relativedelta import relativedelta

# Get the user email to add them to the list
